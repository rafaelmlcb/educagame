...
export function QuizLeaderboard({ ranking, title = 'Ranking', highlightId }: QuizLeaderboardProps) {
  ...
  return (
    <Card sx={{ minWidth: 240, boxShadow: 'none', bgcolor: 'transparent' }}>
      <CardContent sx={{ p: 2, borderRadius: 3, border: '1px solid rgba(255,255,255,0.08)', bgcolor: 'rgba(15, 23, 42, 0.8)' }}>
